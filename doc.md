...
#### 单频点测试：
根据信号于100Hz处的频点的幅度作为输入$X$，将是否含有信号作为$y$，0代表不含信号，1代表含有信号设计基于SVM分类模型。

下面是分类结果

SNR | -45db |  -46db  | -47db | -48db | -49db | -50db | -51db | -52db | -53db | -54db | -55db | -56db | -57db | -58db | -59db | -60db
-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-
准确度 | 0.985 |  0.963  | 0.944 | 0.923 | 0.885 | 0.825 | 0.819 | 0.760 | 0.756 | 0.729 | 0.644 | 0.621 | 0.621 | 0.592 | 0.563 | 0.552
